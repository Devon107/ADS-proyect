...
$query = "INSERT INTO porteria_ci(factura_in,producto_in,id_color,id_talla,fecha) VALUES ('{$Facturas}','{$Productos}','{$color}','{$talla}','{$Fecha}')";
?> <script>alert("");</script> <?php
$mysqli->query($query);

header("Location: porteria_out.php"); // redirecciona
