...
$titulo2 = "Reporte de consignaciones"; //Titulo que va a ir en el cuerpo del documento
	...
	$consulta1="SELECT IDConsignaciones from consignacion";
	//$datos1=mysql_query($consulta1,$conn);
...
$(document).ready(function() {
	...
	$('#example').dataTable( {
		...
		"columns": [
			...
			{ "title": "Referencia"  },
			{ "title": "Telefono" },
			{ "title": "Direccion", "class": "center" },
			{ "title": "Concepto", "class": "center" },
			{ "title": "Valor", "class": "center" },
...
<body>
	...
	<div align="center">
		        <input type="submit" class='button' name="button" id="button" value="Insertar nueva cosignacion"  onclick="top.location.href='../IngresoConsignaciones.php' "  />
	</div>
</body>
</html>