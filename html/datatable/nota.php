...
$titulo2 = "Notas de remisión"; //Titulo que va a ir en el cuerpo del documento
	...
	$consulta1="SELECT id from nota_remision";
...
<body>
	...
	<div align="center">
		        <input type="submit" class='button' name="button" id="button" value="Insertar nueva nota de remision"  onclick="top.location.href='../IngresoNotasRemision.php' "  />
	</div>
</body>
</html>