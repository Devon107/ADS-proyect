...
<div class="row">
 ...
 <a name="Top">
  ...
  <table width="720" border="1" align="left" style="border-collapse:collapse">
    ...
    <tr>
        <td >
            <input type="submit" onclick="this.form.action='inr_eliminar.php'" class='button' name="buttonb" id="buttonb" value="Eliminar"  />
        </td>
        <td >
            <input type="submit" onclick="this.form.action='man_nota_remision.php'" class='button' name="buttonc" id="buttonc" value="Cancelar"  />
        </td>
    </tr>
  </table>
  ...
  <tr>
      ...
      <!--<input placeholder="Pedro Joven" value="<?php echo $num; ?>" type="text" name="tnr" id="tnr"  required  /></td>-->
	  <?php echo $num; ?>
    </tr>
  <tr>
  ...
  while($row=mysqli_fetch_array($result))
    ...
    $v2 = $row[2];
    $v3 = $row[3];
    echo "<tr> <td>".$v1."</td> <td>".$v2."</td> <td>".$v3."</td> </tr>";
    }
    echo"</table>";
  }
    $conn->close();
  ...
  ?>
  <br><br><br><br><br><br>
  <input type="submit" onclick="this.form.action='man_nota_remision.php'" class='button' name="eliminar" id="eliminar" value="Confirmar"  />
  <?php
}
  //--------------------------------------------------------------------------------------------------------
