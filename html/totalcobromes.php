<?php 
	...
	$conn=get_db_conn();
	$titulo2 = "Total de Dinero Pendiente y Cancelado por Mes"; //Titulo que va a ir en el cuerpo del documento
		include("base/titulo.php"); /* $titulo2 debe estar antes de include() */
	//ACA SE SELECCIONAN TODOS LOS DATOS DE LA TABLA
	$consulta="SELECT Estado, SUM(Monto) AS Monto , MONTH(Fecha) AS Fecha FROM Cobro WHERE Fecha BETWEEN '2000-07-05' AND DATE_ADD('2015-11-10',INTERVAL 1 DAY) GROUP BY Estado,MONTH(Fecha)";
...
<html>
	...
	<table>
	<tr><td style="background-color:#DCDCDC";></td><td style="background-color:#DCDCDC";></td><td style="background-color:#DCDCDC";></td><td> Cancelado</td></tr>
	<tr><td style="background-color:#97BBCD";></td><td style="background-color:#97BBCD";></td><td style="background-color:#97BBCD";></td><td>Pendiente</td></tr>
	</table>
	</body>
</html>
