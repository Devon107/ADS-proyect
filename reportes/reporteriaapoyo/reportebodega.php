            ...
            <div align="center" class="large-12 about-box">
                <div class="black-box">
                    <table class="large-9 about-box" border="1" align="center">
                        ...
                        $sql="SELECT b.idBodega, s.nombre AS sucursal, b.nombre FROM bodega AS b INNER JOIN sucursal AS s ON s.idSucursal = b.idSucursal";
                        $sqlSearch=$sql;
                        $pagination->setSQLSearch($sqlSearch);
                        $sqlNumRows = "SELECT COUNT(idBodega) AS numTotal FROM bodega";
                        ...
                        if (mysql_num_rows($SQLresult)>=1):
                            ...
                            while (list($idBodega, $sucursal, $nombre) = mysql_fetch_row($SQLresult)):?>
                                <tr>
