            ...
            <div align="center" class="large-12 about-box">
                <div class="black-box">
                    <table class="large-10 about-box" border="1" align="center">
                        ...
                        $sql="SELECT e.idEmpleado, CONCAT(p.Primer_Nombre, ' ', p.Primer_Apellido) AS persona, e.usuario, e.cargo, e.salario, e.estado FROM empleado AS e INNER JOIN persona AS p ON p.idPersona = e.idPersona";
                        $sqlSearch=$sql;
                        $pagination->setSQLSearch($sqlSearch);
                        $sqlNumRows = "SELECT COUNT(idEmpleado) AS numTotal FROM empleado";
                        ...
                        if (mysql_num_rows($SQLresult)>=1):
                            ...
                            while (list($idempleado, $persona, $usuario, $cargo, $salario, $estado) = mysql_fetch_row($SQLresult)):?>
                                <tr>
