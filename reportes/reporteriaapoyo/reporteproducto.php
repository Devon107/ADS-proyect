                ...
                <div class="black-box">
                    <table class="large-11 about-box" border="1" align="center">
                        ...
                        if (mysql_num_rows($SQLresult)>=1):
                            ...
                            while (list($estilo, $nombre, $proveedor, $codigoOrigen, $linea, $descripcion, $catalogo, $nPag, $marca, $propiedad, $garantia, $observacion) = mysql_fetch_row($SQLresult)):?>
                                <tr>
                                    <td><?php echo $estilo;?></td>
                                    <td><?php echo $nombre;?></td>
                                    <td><?php echo $proveedor;?></td>
                                    <td><?php echo $codigoOrigen;?></td>
