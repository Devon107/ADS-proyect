            ...
            <div align="center" class="large-12 about-box">
                <div class="black-box">
                    <table class="large-10 about-box" border="1" align="center">
                        ...
                        $sql="SELECT idcatalogo, nombre, descripcion, fechaInicio, fechaCierre, imagen FROM catalogo";
                        $sqlSearch=$sql;
                        $pagination->setSQLSearch($sqlSearch);
                        $sqlNumRows = "SELECT COUNT(idcatalogo) AS numTotal FROM catalogo";
                        ...
                        if (mysql_num_rows($SQLresult)>=1):
                            ...
                            while (list($idcatalogo, $nombre, $descripcion, $fechaInicio, $fechaCierre, $imagen) = mysql_fetch_row($SQLresult)):?>
                                <tr>
