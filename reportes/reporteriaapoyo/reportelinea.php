            ...
            <div align="center" class="large-12 about-box">
                <div class="black-box">
                    <table class="large-9 about-box" border="1" align="center">
                        ...
                        $sql="SELECT idlinea, nombre, descripcion FROM linea";
                        $sqlSearch=$sql;
                        $pagination->setSQLSearch($sqlSearch);
                        $sqlNumRows = "SELECT COUNT(idlinea) AS numTotal FROM linea";
                        ...
                        if (mysql_num_rows($SQLresult)>=1):
                            ...
                            while (list($idlinea, $nombre, $descripcion) = mysql_fetch_row($SQLresult)):?>
                                <tr>
