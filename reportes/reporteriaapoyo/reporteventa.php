            ...
            <div align="center" class="large-12 about-box">
                <div class="black-box">
                    <table class="large-10 about-box" border="1" align="center">
                        ...
                        $sql="SELECT o.idOrdenDeVenta, o.fechaCreacion, o.fechaEntrega, CONCAT(p.Primer_Nombre, ' ', p.Primer_Apellido) AS cliente, o.estado FROM ordendeventa AS o INNER JOIN cliente AS c ON c.idCliente = o.idCliente INNER JOIN persona AS p ON p.idPersona = c.idPersona";
                        $sqlSearch=$sql;
                        $pagination->setSQLSearch($sqlSearch);
                        $sqlNumRows = "SELECT COUNT(idOrdenDeVenta) AS numTotal FROM ordendeventa";
                        ...
                        if (mysql_num_rows($SQLresult)>=1):
                            ...
                            while (list($idOrdenDeVenta, $fechaCreacion, $fechaEntrega, $cliente, $estado) = mysql_fetch_row($SQLresult)):?>
                                <tr>
                                    <td><?php echo $idOrdenDeVenta;?></td>
