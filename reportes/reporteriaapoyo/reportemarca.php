            ...
            <div align="center" class="large-12 about-box">
                <div class="black-box">
                    <table class="large-9 about-box" border="1" align="center">
                        ...
                        $sql="SELECT idMarca, nombre, descripcion FROM marca";
                        $sqlSearch=$sql;
                        $pagination->setSQLSearch($sqlSearch);
                        $sqlNumRows = "SELECT COUNT(idMarca) AS numTotal FROM marca";
                        ...
                        if (mysql_num_rows($SQLresult)>=1):
                            ...
                            while (list($idmarca, $nombre, $descripcion) = mysql_fetch_row($SQLresult)):?>
                                <tr>
