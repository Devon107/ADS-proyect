...
//SI ES LA PRIMERA PÁGINA DESHABILITO EL BOTON DE PREVIOUS, MUESTRO EL 1 COMO ACTIVO Y MUESTRO EL RESTO DE PÁGINAS
 if ($page == 1) {
    ...
    for($i= $page+1; $i<= $lastpage ; $i++){?>
            <li><a href="BusquedaCobros.php?page=<?php echo $i;?>"><?php echo $i;?></a></li>
 <?php }
       //Y SI LA ULTIMA PÁGINA ES MAYOR QUE LA ACTUAL MUESTRO EL BOTON NEXT O LO DESHABILITO
    if($lastpage > $page ){?>       
      <li class="next"><a href="BusquedaCobros.php?page=<?php echo $nextpage;?>" >Next &raquo;</a></li><?php
    }else{?>
...
<?php  }
  ...
  ?>
      <li class="previous"><a href="BusquedaCobros.php?page=<?php echo $prevpage;?>"  >&laquo; Previous</a></li><?php
      for($i= 1; $i<= $lastpage ; $i++){
                       //COMPRUEBO SI ES LA PÁGINA ACTIVA O NO
            if($page == $i){
        ?>  <li class="active"><?php echo $i;?></li><?php
            }else{
        ?>  <li><a href="BusquedaCobros.php?page=<?php echo $i;?>" ><?php echo $i;?></a></li><?php
            }
      }
